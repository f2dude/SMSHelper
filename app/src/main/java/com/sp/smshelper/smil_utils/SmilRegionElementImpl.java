...
public class SmilRegionElementImpl extends SmilElementImpl implements
    ...
    private static final String TAG = SmilRegionElementImpl.class.getSimpleName();
    ...
    public int getLeft() {
        try {
            ...
            if (LOCAL_LOGV) {
                Log.d(TAG, "Left attribute is not set or incorrect.");
            }
        }
        try {
            ...
            if (LOCAL_LOGV) {
                Log.d(TAG, "Right or width attribute is not set or incorrect.");
            }
        }
        return 0;
    }
    ...
    public int getTop() {
        try {
            ...
            if (LOCAL_LOGV) {
                Log.d(TAG, "Top attribute is not set or incorrect.");
            }
        }
        try {
            ...
            if (LOCAL_LOGV) {
                Log.d(TAG, "Bottom or height attribute is not set or incorrect.");
            }
        }
        return 0;
    }
    ...
    public int getHeight() {
        try {
            ...
            if (LOCAL_LOGV) {
                Log.d(TAG, "Height attribute is not set or incorrect.");
            }
        }
        int bbh = ((SMILDocument) getOwnerDocument()).getLayout().getRootLayout().getHeight();
        try {
        ...
        try {
            ...
            if (LOCAL_LOGV) {
                Log.d(TAG, "Bottom attribute is not set or incorrect.");
            }
        }
        return bbh;
    }
    ...
    public int getWidth() {
        try {
            ...
            if (LOCAL_LOGV) {
                Log.d(TAG, "Width attribute is not set or incorrect.");
            }
        }
        int bbw = ((SMILDocument) getOwnerDocument()).getLayout().getRootLayout().getWidth();
        try {
        ...
        try {
            ...
            if (LOCAL_LOGV) {
                Log.d(TAG, "Right attribute is not set or incorrect.");
            }
        }
        return bbw;
    }
