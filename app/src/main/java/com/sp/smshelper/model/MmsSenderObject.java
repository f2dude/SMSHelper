...
public class MmsSenderObject {
     ...
     */
    public MmsSenderObject(String text, String address) {
     ...
     */
    public MmsSenderObject(String text, String address, String subject) {
     ...
     */
    public MmsSenderObject(String text, String[] addresses) {
        this.text = text;
     ...
     * @param subject   is the subject of the mms message
     */
    public MmsSenderObject(String text, String[] addresses, String subject) {
        this.text = text;
        this.addresses = addresses;
        this.images = new Bitmap[0];
     ...
     */
    public MmsSenderObject(String text, String address, Bitmap image) {
     ...
     * @param subject is the subject of the mms message
     */
    public MmsSenderObject(String text, String address, Bitmap image, String subject) {
     ...
     * @param image     is the image that you want to send
     */
    public MmsSenderObject(String text, String[] addresses, Bitmap image) {
     ...
     * @param subject   is the subject of the mms message
     */
    public MmsSenderObject(String text, String[] addresses, Bitmap image, String subject) {
     ...
     */
    public MmsSenderObject(String text, String address, Bitmap[] images) {
     ...
     * @param subject is the subject of the mms message
     */
    public MmsSenderObject(String text, String address, Bitmap[] images, String subject) {
     ...
     * @param images    is an array of images that you want to send
     */
    public MmsSenderObject(String text, String[] addresses, Bitmap[] images) {
        this.text = text;
        this.addresses = addresses;
        this.images = images;
        this.subject = null;
     ...
     * @param subject   is the subject of the mms message
     */
    public MmsSenderObject(String text, String[] addresses, Bitmap[] images, String subject) {
        this.text = text;
        this.addresses = addresses;
        this.images = images;
        this.subject = subject;
