...
public class SendMmsActivity extends BaseActivity {
    ...
    public void onSendClicked() {
        ...
        if (mViewModel.getSubscriptionId() > -1) {
            if (!mViewModel.isCellularAvailable(this)) {
                Toast.makeText(this, getString(R.string.not_connected_to_network), Toast.LENGTH_LONG).show();
                return;
            }
            if (!mViewModel.isMobileDataEnabled(this)) {
